            ...
            <div className="container">
                <div className="header_row">
                    ...
                    <nav className="header_nav">
                        <ul>
                            <img src={logoSearch} alt="nav_search" className='nav_item'></img>
                            <img src={logoProfile} alt="nav_profile" className='nav_item'></img>
                            <img src={logoFav} alt="nav_fav" className='nav_item'></img>
                            <img src={logoBag} alt="nav_bag" className='nav_item'></img>
                        </ul>
                    </nav>
                </div>
            </div>
